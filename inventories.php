...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Inventories
    ...
    <div class="row">
      ...
      <table><tr>
        ...
        if(isset($_POST['search'])){
            $sql = "SELECT * FROM inventory JOIN film ON inventory.film_id=film.film_id WHERE inventory_id =".$_POST['search'];
            $result = mysqli_query($conn, $sql);
            $resultCheck = mysqli_num_rows($result);
            if ($resultCheck >0){
            while($row = mysqli_fetch_assoc($result)){
            echo "<tr><td class='firstcolumn'><a href='inventory.php?inventoryid=".$row['inventory_id']."'>".$row['inventory_id']."</a></td><td>".$row['store_id']."</td><td>".ucwords(strtolower($row['title']))."</td><td>".$row['available']."</td></tr>";
            }
        }

        }else{
      
      $sql = "SELECT * FROM inventory JOIN film ON inventory.film_id=film.film_id LIMIT 1000;";
      $result = mysqli_query($conn, $sql);
      $resultCheck = mysqli_num_rows($result);
      ...
      <div class="col-md-4">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body" style="margin-top:-25px;">
              ...
              <form action="inventories.php" method="post" class="form-inline p-3">
              <input type="text"class="form-control " style ="width:70%;"id="search" name="search" placeholder="Search by inventory id">
